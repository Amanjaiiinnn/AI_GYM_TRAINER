...
class ShoulderPressDetector(BaseExercise):
    ...
    def process(self, landmarks) -> dict:
        ...
        if left_vis >= right_vis:  # acc which visible is more
        ...
        if elbow_angle >= self.UP_THRESHOLD:     # e;bow extension status for shoulder press detection and feedback.
        ...
        if back_angle >= 160:   # bACK ANGLE ARC OF SPINE FOR SHOULDER PRESS DETECTION AND FEEDBACK
